...
export default class Artist extends Component {
    ...
    handleRandom = async () => {
      try {
        const response = await fetch('https://spotify-back-r0od.onrender.com/artists/random', {
          method: 'GET',
        });
    ...
    componentDidMount() {
      ...
      handleList = async () => {
        try {
          const response = await fetch('https://spotify-back-r0od.onrender.com/artists', {
            method: 'GET',
          });
      ...
      search = async () => {
        try {
          const response = await fetch(`https://spotify-back-r0od.onrender.com/artists?query=${encodeURIComponent(this.state.searchQuery)}`, {
            method: 'GET',
            credentials: 'include',
          });
