...
export default class Song extends Component {
    ...
    handleList = async () => {
      try {
        const response = await fetch('https://spotify-back-vsee.onrender.com/songs', {
          method: 'GET',
        });
    ...
    handleRandom = async () => {
      try {
        const response = await fetch('https://spotify-back-vsee.onrender.com/random', {
          method: 'GET',
        });
    ...
    componentDidMount() {
      ...
      search = async () => {
        try {
          const response = await fetch(`https://spotify-back-vsee.onrender.com/songs?query=${encodeURIComponent(this.state.searchQuery)}`, {
            method: 'GET',
            credentials: 'include',
          });
